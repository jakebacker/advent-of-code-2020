...
grid_size = 23
grid_middle = int((grid_size-2)/2)

grid = [[[["." for x in range(grid_size)] for y in range(grid_size)] for z in range(grid_size)] for w in range(grid_size)]
...
grid[grid_middle][grid_middle] = plane
                        ...
                        for dz in range(-1, 2):
                            for dy in range(-1, 2):
                                for dx in range(-1, 2):
                                    ...
                                    new_y = y + dy
                                    new_x = x + dx
                                    if 0 <= new_w < len(grid) and 0 <= new_z < len(grid[new_w]) \
                                            and 0 <= new_y < len(grid[new_w][new_z]) \
                                            and 0 <= new_x < len(grid[new_w][new_z][new_y]):
